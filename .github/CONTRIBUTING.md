# Contributing to inky-docker 🚀

Thank you for considering contributing to
[inky-docker](https://github.com/vascoguita/inky-docker). We appreciate
...
1. **Navigate to Issues:**
   ...
   Visit the
   [Issues section](https://github.com/vascoguita/inky-docker/issues) of the
   repository.
...
1. **Fork the Repository:**
   ...
   [inky-docker repository](https://github.com/vascoguita/inky-docker) to
   create a copy in your GitHub account.

2. **Find the Issue:**

   * Go to the "Issues" tab of the upstream
     [inky-docker repository](https://github.com/vascoguita/inky-docker).
...
5. **Open a Pull Request:**
   ...
   * On the pull request page, set:
      * "base repository" to "vascoguita/inky-docker".
      * "base" to "master".
      * "head repository" to "YOUR_USERNAME/inky-docker".
